/// A route that can be registered to the `Router`.
///
/// This contains a collection of `PathComponent`s, the path, and an output.
/// The route's path defines how it will match paths passed to `Router.route(...)`.
///
...
public final class Route<Output>: Extendable {
    ...
    /// This will be returned by `Router.route(...)` if this route matches.
